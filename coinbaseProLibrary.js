...
class coinbaseProLib {
    ...
    async getFearAndGreedIndexValue() {
        try {
            const fullpath = "https://api.alternative.me/fng/";
            ...
            if (attempts < numberOfAttempts - 1) {
                ...
                const message = "Error occurred in getFearAndGreedIndexValue method. Number of attempts: " + numberOfAttempts;
